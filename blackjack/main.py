...
def calculate_score(cards):
    """Take a list of cards and calculate the score of cards """
...
def play_game():
    ...
    while not game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            option = input("choose 'y' to draw another card, and 'n' to end the game")
            if option == 'y':
                user_cards.append(deal_card())
            else:
                game_over = True
    ...
    print(f"Computer's final hand: {computer_cards}, and its final score: {computer_score}")
